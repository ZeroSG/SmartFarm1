...
class Order extends StatefulWidget {
  ...
  List<dynamic>? cmiid;
  int? id;
   Order({ Key? key,this.Token,this.day,this.day1 ,this.default_ship,this.default_unit,this.farmnum,this.cmiid,this.id}) : super(key: key);
...
class _OrderState extends State<Order> {
 ...
 List<dynamic> nowresult1_1 = []; 
  ...
  late List<bool> valuefirst = List<bool>.generate(nowresult1_1.length, (i) => false);
...
child: Padding(
                    ...
                    child: by ?Row(
                            ...
                            size: 28,
                                ...
                                child:widget.default_unit == null ? DropdownButton<String>(
                                         icon: Icon(
 ...
 child: Padding(
                      ...
                      child: by ?Row(
                            ...
                            size: 28,
                                ...
                                : DropdownButtonHideUnderline(
                                  child: widget.default_ship == null ? DropdownButton<String>(
                                         icon: Icon(
                              Icons.arrow_drop_down_circle,
                              size: 20,
                            ),
                        ...
                        onChanged: (Ship_Condition) {
                         setState(() {
                                    ...
                                    Ship_Conditionnameedit = Ship_Condition!;
 ...
 child: Padding(
                      ...
                      child:by ?Row(
                            ...
                            size: 28,
                                ...
                                : DropdownButtonHideUnderline(
                                  child: Feed_Formula == null ? DropdownButton<String>(
                                         icon: Icon(
                              Icons.arrow_drop_down_circle,
                              size: 20,
                            ),
                        ...
                        items:  Feed_Formula! 
                            .map((Feed_Formula) => DropdownMenuItem<String>(
    ...
    return Container(
      ...
      color: Colors.white,
                    ...
                    child: Padding(
                       padding: EdgeInsets.only(left: 10, right: 10),
                      child: DropdownButtonHideUnderline(
                                  child: widget.cmiid == null ? DropdownButton<String>(
                                         icon: Icon(
                              Icons.arrow_drop_down_circle,
                              size: 20,
                            ),
...
child:    GestureDetector(
  ...
  child: Text("${dateTimeEnd!.year}-${dateTimeEnd!.month}-${dateTimeEnd!.day}",
       ...
       child: Padding(
        ...
        Container(
           decoration: BoxDecoration(
            ...
            border: Border.all(color: Color.fromARGB(255, 194, 194, 194), width: screenW * 0.005),
                       ...
                       : Column(
                         children: [
                           ...
                           itemCount: nowresult1_1.length,
                            key: Key('builder2 ${selected1.toString()}'),
  ...
  //  Feed_Formulanameedit =  ' ';
   Unitnameedit = '${nowresult1_1[index]['c_unit']}';
    ...
    Remark2.text =   nowresult1_1[index]['c_remark'];
       ...
       if((nowresult1_1[index]['n_confirm'] == 0)&&Start!.compareTo(OOO2!) >= 0){
       return Row(
