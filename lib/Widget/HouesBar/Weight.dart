    ...
    try {
      ...
      var ressum = await http.post(urlsum,
          ...
          body: jsonEncode(<String, dynamic>{
            "Farm": widget.farmnum,
            "House": widget.num,
            "Date":  "${dateTime1_!.year}-${dateTime1_!.month}-${dateTime1_!.day}"
          }));
        ...
        setState(() {
          ...
          loading4 = false;
           ...
           for(int i= 0;i<nowresult4_1.length;i++){
             var splitted = nowresult4_1[i]['${nowresult4_1[i].keys.elementAt(0)}'].split('(').first;
            ...
            //  print('_products2 ${splitted1[2]}');
             ...
             if((int.parse(splitted1[1])<dateTime1_.month-3)&&(int.parse("20${splitted1[2]}")==dateTime1_.year)){
             _products1 += [nowresult4_1[i]];
           
             }
             if((int.parse(splitted1[0])<=dateTime1_.day&&int.parse(splitted1[1])==dateTime1_.month-3)){
             _products1 += [nowresult4_1[i]];
      ...
      if (ressum.statusCode == 200) {
        var result6_1 = json.decode(ressum.body)['result']['view1'];
          print(result6_1);
           ...
           print("${dateTime_!.year}-${dateTime_!.month}-${dateTime_!.day} 00:00:00",);
        setState(() {
                                  ...
                                  child: TextButton(
                                    onPressed: () {
                                       if(nowresult0_2 == null){
                                         ...
                                         API_edit_weight_setting(widget.Token,widget.farmnum,widget.num,ALL,EndS,EndE,double.parse(n_size_s_min.text),double.parse(n_size_m_min.text),double.parse(n_size_m_max.text),double.parse(n_size_l_max.text),double.parse(n_per_yield.text),double.parse(n_per_loss.text));
            ...
            : Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: TextButton(
                      onPressed: () {
                         saveExcelAgeinformation(nowresult2_1,'AverageHourlyWeightData');
                      },
                      child: Text(
                        'Download',
                        style: TextStyle(
                    ...
                    fontSize: 13,fontFamily: 'Montserrat',),
                            ...
                            behaviors: [
                              ...
                              new charts.ChartTitle(
                                ...
                                titleStyleSpec:
                                    charts.TextStyleSpec(fontSize: 14,fontFamily: 'Montserrat',color: charts.MaterialPalette.black,),
                              ),
                              new charts.ChartTitle(
                                'gram',
                                            ...
                                            if (model.hasDatumSelection) {
                                              ...
                                              model.selectedDatum.forEach(
                                                ...
                                                selectedDatum2!.add({
                                                  'title':
                                                      '${datumPair.datum['device']}',
                                                  for (int i = 1;i <nowresult3_2[0].keys.length;i++)
                                                    'subTitle${i}': '${datumPair.datum['${nowresult3_2[0].keys.elementAt(i)}'] ?? 'undefeated'}',
                                                });
                                              });
                                            }
                                          })
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: TextButton(
                        onPressed: () {
                          saveExcelAgeinformation(nowresult6_1,'SizeComparisonData');
                        },
                        child: Text(
                          'Download',
                          style: TextStyle(
